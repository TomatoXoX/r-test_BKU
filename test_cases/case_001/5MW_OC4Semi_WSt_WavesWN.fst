...
---------------------- ENVIRONMENTAL CONDITIONS --------------------------------
    9.80665   Gravity         - Gravitational acceleration (m/s^2)
      1.1802284   AirDens         - Air density (kg/m^3)
...
False         SumPrint        - Print summary data to "<RootName>.sum" (flag)
     ...
     0.0125   DT_Out          - Time step for tabular output (s) (or "default")
          ...
          5   OutFileFmt      - Format for tabular (time-marching) output file (switch) {1: text file [<RootName>.out], 2: binary file [<RootName>.outb], 3: both 1 and 2, 4: uncompressed binary [<RootName>.outb, 5: both 1 and 4}
